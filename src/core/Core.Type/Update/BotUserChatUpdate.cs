...
[JsonConverter(typeof(BotUserChatUpdateJsonConverter))]
public sealed record class BotUserChatUpdate
{
    public BotUserChatUpdate(int updateId, BotUser user, BotChat chat)
    {
        UpdateId = updateId;
        User = user;
        Chat = chat;
